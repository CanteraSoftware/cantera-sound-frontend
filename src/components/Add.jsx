          ...
          <div className="Add-container">
            ...
            <form onSubmit={handleSubmit} className="Add-content">
              <div className="Add-content-input">
                ...
                />
                {errors.nameFile && (
                  <div className="Add-error">{errors.nameFile}</div>
                )}
              </div>
              <div className="Add-content-input">
                ...
                />
                {errors.nameAuthor && (
                  <div className="Add-error">{errors.nameAuthor}</div>
                )}
              </div>
              <div className="Add-content-input">
                ...
                {errors.category && (
                  <div className="Add-error">{errors.category}</div>
                )}
              </div>
              <div className="Add-content-input">
                ...
                {errors.genres && (
                  <div className="Add-error">{errors.genres}</div>
                )}
              </div>
              <div className="Add-content-input">
              ...
              <div className="Add-container-btn">
                <button className="Add-btn-cancel" onClick={handleClick}>
                  Cancelar
                </button>
